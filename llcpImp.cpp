...
void SortedMergeRecur(Node*& xhead, Node*& yhead, Node*& zhead)
{
    ...
    //if the Y-list is empty reassign the X into the new pointer
    ...
    //if the X-list is empty reassign the Y into the new pointer
    else if (xhead == 0 && yhead != 0){
        zhead = yhead;
    ...
    //if neither list is empty we compare which is greater and reassign accordingly
    else {
